...
# License: GNU GPL
#
# Runs the full Apache JMeter HTTP Test Script Recorder security scanning chain:
# 1. Port check
# 2. TLS detection  
# 3. Certificate collection
# 4. Apache JMeter HTTP Test Script Recorder security testing
#
# Always returns 0 for successful chain execution, regardless of final jmeter.py result
...
echo "=== Apache JMeter HTTP Test Script Recorder Security Scan Chain for $HOST:$PORT ==="
...
if [ "$TLS_DETECTED" = true ]; then
    ...
    # Step 4: Apache JMeter HTTP Test Script Recorder TLS testing
    echo ""
...
echo ""
echo "=== Apache JMeter HTTP Test Script Recorder Security Scan Chain Complete ==="
