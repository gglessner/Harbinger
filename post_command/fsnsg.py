#!/usr/bin/env python3
"""
FS NSG Series Firewalls Web UI Security Scanner
Author: Garland Glessner <gglessner@gmail.com>
License: GNU GPL

This script tests FS NSG Series Firewalls Web UI connectivity and reports security configuration:
...
def scan_fsnsg_security(host, port=8181, tls_only=False):
...
def main():
    parser = argparse.ArgumentParser(description='FS NSG Series Firewalls Web UI Security Scanner')
    parser.add_argument('host', help='FS NSG Series Firewalls host to test')
    parser.add_argument('port', nargs='?', type=int, default=8181, help='FS NSG Series Firewalls port (default: 8181)')
    ...
    scan_fsnsg_security(host, port, tls_only)
